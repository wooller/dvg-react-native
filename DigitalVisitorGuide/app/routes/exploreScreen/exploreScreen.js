                ...
                >
                    <View style={{flex: 1}} tabLabel='All'>
                        <FlatList
                            ...
                            renderItem={({item}) => (<ContentAccordion sections={item.key} onPress={() => this.props.navigator.push({screen: 'digitalVisitorGuide.trackScreen', animationType: globalStyles.navigationAnimation})}/>) }
                        />
                    </View>
